...
model = Sequential()
model.add(Conv2D(filters=64, kernel_size=[9,9], kernel_initializer = initializers.he_normal(seed=1), activation="relu", input_shape=(128,128,1)))
# Dim = (120x120x64)
model.add(BatchNormalization())
model.add(AveragePooling2D(pool_size=[2,2], strides=2))
# Dim = (60x60x64)
model.add(Conv2D(filters=128, kernel_size=[9,9], strides=2, kernel_initializer = initializers.he_normal(seed=1), activation="relu"))
# Dim = (26x26x128)
model.add(BatchNormalization())
model.add(AveragePooling2D(pool_size=[2,2], strides=2))
# Dim = (13x13x128)
